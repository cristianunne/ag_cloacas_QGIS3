...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Symbol_final_tramos_dialog_base.ui'))


class Symbol_finalTramosDialog(QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(Symbol_finalTramosDialog, self).__init__(parent)
