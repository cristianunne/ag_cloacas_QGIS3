...
from ..dialogs.TramosAction_dialog import TramosActionDialog
from ..dialogs.Symbol_inicio_tramos_dialog import Symbol_inicioTramosDialog
from ..dialogs.Nodo_Final_Tramo import NodoFinalTramosDialog
from ..dialogs.Symbol_final_tramos_dialog import Symbol_finalTramosDialog
from ..dialogs.Resumen_Final_Tramo_Dialog import ResumenFinalTramosDialog
...
class TramosAction():
    ...
    def __init__(self, iface, toolbar):
        ...
        self.tramos = QAction(QIcon(filename),
                              QCoreApplication.translate("AG_Cloacas", "Agregar Propieades al Tramo"),
